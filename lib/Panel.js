...
var Panel = function (_React$Component) {
  ...
  Panel.prototype.render = function render() {
    var _props = this.props,
        ...
        props = (0, _objectWithoutProperties3['default'])(_props, ['collapsible', 'header', 'id', 'footer', 'expanded', 'headerRole', 'anchorClass', 'panelRole', 'className', 'children', 'onEnter', 'onEntering', 'onEntered', 'onExit', 'onExiting', 'onExited']);
